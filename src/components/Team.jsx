...
const Team = () => {
  return (
    <div className="w-full text-white flex flex-col items-center my-14">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 place-items-center gap-4 md:gap-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 xl:grid-cols-6 place-items-center gap-4 px-4 md:gap-6 md:px-6 lg:gap-8 lg:px-8">
