...
const Navigation = () => {
  ...
  return (
    <>
      <div className="flex lg:hidden w-full bg-none h-12 items-center fixed z-20 bg-[#1e4e4a]">
        <div
      ...
      >
        <div className="overflow-y-auto bg-[#1e4e4a] h-full flex flex-col justify-between items-center w-full">
